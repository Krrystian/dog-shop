...
const Footer = () => {
  return (
    <div className="w-full min-h-[313px] bg-[rgb(73,128,128)] grid md:grid-cols-6 grid-cols-2 text-white">
      <div className="col-span-2 py-2 md:py-0 items-center flex justify-center">
        <h2 className="text-4xl">
          <span className="text-cyan-950">Dog</span>Shop
        </h2>
      </div>
      <div className="items-center py-3 md:py-0 md:items-start flex flex-col justify-center cursor-pointer">
